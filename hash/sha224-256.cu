...
namespace cuda
{
    ...
    __device__ static void SHA224_256Finalize(SHA256Context* context, uint8_t Pad_Byte);

    __device__ static void SHA224_256PadMessage(SHA256Context* context, uint8_t Pad_Byte);
    ...
    __device__ static int SHA224_256ResultN(SHA256Context* context, uint8_t Message_Digest[], int HashSize);
     ...
     *
     */
    __device__ int SHA224Input(SHA224Context* context, const uint8_t* message_array, unsigned int length)
    {
     ...
     *   sha Error Code.
     */
    __device__ int SHA224FinalBits(SHA224Context* context, const uint8_t message_bits, unsigned int length)
    {
     ...
     *   sha Error Code.
     */
    __device__ int SHA224Result(SHA224Context* context, uint8_t Message_Digest[SHA224HashSize])
    {
     ...
     *   sha Error Code.
     */
    __device__ int SHA256Input(SHA256Context* context, const uint8_t* message_array, unsigned int length)
    {
     ...
     *   sha Error Code.
     */
    __device__ void SHA224_256Finalize(SHA256Context* context, uint8_t Pad_Byte)
    {
        int i;
     ...
     *   Nothing.
     */
    __device__ void SHA224_256PadMessage(SHA256Context* context, uint8_t Pad_Byte)
    {
        /*
     ...
     * *   sha Error Code.
     */
    __device__ int SHA224_256ResultN(SHA256Context* context, uint8_t Message_Digest[], int HashSize)
    {
        int i;
